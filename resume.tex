...
\section{Projects}
  ...
  \resumeSubItem{Purple rain}
    \resumeSubheading{Using P5.js framework   https://competent-lamarr-e68a09.netlify.app/purplerain/purplerain}
  \resumeSubItem{Human Vs. A.I. Tic tac toe:}
    \resumeSubheading{Using AI technique and HTML, CSS, JS    https://competent-almeida-ac430d.netlify.app/tictactoe.html}    
  \resumeSubItem{Todo List}
    \resumeSubheading{Using HTML, CSS, JS    https://nervous-swartz-10e956.netlify.app/todolist/index.html}
...
\section{Skills}
 \resumeSubHeadingListStart
    ...
    \item {
     \textbf{Back-end}{: Node.js, Ruby on Rails, Express, Flask, Redis, Spring Boot, Spring MVC, Hibernte, WebSocket, GraphQL, MongoDB, dynamoDB, MySQL, AWS}
    }
    \item {
